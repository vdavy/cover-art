...
public class PollingService {
	...
	private SongHistoryItemDTO insertSong(SongHistoryItemDTO songToInsert) {
		...
		if ((songToInsert != null) && (!(lastSong.getArtist().equalsIgnoreCase(songToInsert.getArtist()) && lastSong.getTitle().equalsIgnoreCase(songToInsert.getTitle())))) { //if not equals
